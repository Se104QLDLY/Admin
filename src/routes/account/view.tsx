      ...
      <div className="min-h-screen p-6" style={{ overflow: 'visible' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Basic Info */}
            <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-orange-700 font-semibold mb-1">Tên đăng nhập</label>
                  <p className="bg-white px-4 py-2 rounded-lg border text-gray-800 font-semibold">{account.username}</p>
                </div>
                <div>
                  <label className="block text-orange-700 font-semibold mb-1">Họ tên</label>
                ...
                <div>
                  <label className="block text-orange-700 font-semibold mb-1">Số điện thoại</label>
                  <div className="bg-white px-4 py-2 rounded-lg border flex items-center gap-2">
                ...
                <div className="md:col-span-2">
                  <label className="block text-orange-700 font-semibold mb-1">Địa chỉ</label>
                  <div className="bg-white px-4 py-2 rounded-lg border flex items-center gap-2">
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-emerald-700 font-semibold mb-2">Vai trò</label>
                ...
                <div>
                  <label className="block text-emerald-700 font-semibold mb-2">Trạng thái</label>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-xl">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-orange-600 font-semibold">{account.username}</span>
                </div>
                <div className="flex justify-between items-center">
