...
// CSS hiệu ứng (nếu chưa có):
// .animate-fade-in-fast { animation: fadeInFast 0.25s; }
// @keyframes fadeInFast { from { opacity: 0; transform: translateY(-10px);} to { opacity: 1; transform: none; } } 